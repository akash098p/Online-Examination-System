                ...
                @if(auth()->user()->role === 'admin')
                    <div class="flex items-center gap-2 rounded-lg border border-white/25 bg-black/25 px-3 py-1 text-white">
                        ...
                        <form method="POST" action="{{ route('logout') }}"
                            ...
                            @csrf
                            <button type="submit" class="flex items-center justify-center rounded-lg border border-red-300/30 bg-red-900/40 px-3 py-1 text-red-100 hover:bg-red-800/60 transition" title="Logout">
